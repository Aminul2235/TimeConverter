...
public class TimeZoneList extends AppCompatActivity {
    ...
    private void intent()
    {
        Intent intent=new Intent(getApplicationContext(),TimeConverter.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, "http://api.timezonedb.com/v2/list-time-zone?key=Z35J0I51CRWE&format=json", new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0;i<jsonArray.length();i++)
                    {
                        ...
                        GetZones getZones=new GetZones(countryName,zoneName,countryCode,timestamp,gmtOffset);
                ...
                ListAdapter listAdapter=new TimeConverterAdapter(arrayList,getApplicationContext());
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                if (error instanceof TimeoutError || error instanceof NoConnectionError) {
                    ...
                    Intent intent=new Intent(TimeZoneList.this,TimeConverter.class);
                    startActivity(intent);
...
class GetZones
{
    private String countryName,countryCode,zoneName;
    ...
    public GetZones(String countryName, String zoneName, String countryCode, long timestamp, long gmtOffset) {
